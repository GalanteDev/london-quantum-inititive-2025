  ...
  if (error || !researcher) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-black to-gray-900">
        ...
        <Link href="/about" className="inline-flex items-center px-4 py-2 bg-white/10 text-white rounded-sm hover:bg-white/20 transition-colors">
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#111111] to-[#1a1a1a]">
      ...
      <section className="pt-24 pb-0 md:pt-28 md:pb-0 relative overflow-hidden researcher-hero">
        ...
        <div className="container relative z-10">
          <Link href="/about" className="inline-flex items-center text-sm text-white/60 hover:text-white transition-colors mb-8 group">
              ...
              <div className="md:col-span-2 p-6 md:p-8 flex flex-col">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  ...
                  {researcher.phdSupervisor && (
                    <div className="bg-black/30 rounded-sm p-4 border border-white/5">
                      <h3 className="text-sm font-medium text-white/70 mb-2">PhD Supervisor</h3>
                      <p className="text-white text-base">
                        {researcher.phdSupervisor.map((name, index, arr) => {
                          ...
                          return (
                            <span key={name}>
                              <Link href={supervisorUrl} className="text-blue-500 hover:underline">
                                {name}
                              </Link>
                              {!isLastName && " - "}
                            </span>
                  ...
                  {researcher.nextJob && (
                    <div className="bg-black/30 rounded-sm p-4 border border-white/5">
                      <h3 className="text-sm font-medium text-white/70 mb-2">Next Job</h3>
                      <p className="text-white text-base">{researcher.nextJob}</p>
                    </div>
                  )}
                </div>
